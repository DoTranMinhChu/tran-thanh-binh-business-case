      ...
      <div className="container p-4 mx-auto">
        <section className="py-4">
          <p className="py-2 text-justify">
            ...
            the feasibility of the four alternatives. The weight of each
            proposal is calculated by taking the difference between the total
            scores of the forces supporting the proposal and the total scores of
            the forces against the proposal:
          </p>
          <p className="py-2 text-justify">
            ...
            <div className="overflow-hidden border-b border-gray-200 rounded shadow">
              <table className="min-w-full bg-white">
                <thead className="text-white bg-[#4C90CA]">
                  <tr>
                    <th className="w-[40%] px-4 py-3 text-sm font-semibold text-left uppercase">
                      Driving forces
                    </th>
                    ...
                    <th className="w-[40%] px-4 py-3 text-sm font-semibold text-center uppercase ">
                      Restraint forces
                    </th>
                  </tr>
                </thead>
                <tbody className="text-white bg-[#33576F]">
                  <tr>
                    <td colSpan={4} className="w-full px-4 py-3 text-center">
                      Alternative 1: Organization restructure (Weight: 3)
                    </td>
                  </tr>
                  <tr className="text-white bg-[#2C404E]">
                    <td className="w-[40%] px-4 py-3 text-left">
                      Low investment cost
                    </td>
                  ...
                  <tr className="text-white bg-[#2C404E]">
                    ...
                    <td className="w-[40%] px-4 py-3 text-left "></td>
                  </tr>
                  <tr>
                    <td colSpan={4} className="w-full px-4 py-3 text-center">
